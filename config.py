...
hardware = dict(
  AWG = dict(
    PWM_freq=1e7,       #Frequency of pulses sent to the AWG, in Hz
  ...
  IO = dict(
    gain=0              #Analog gain, integer in [0, 1, 2, 3]
  ),
  ADC = dict(
    SPS=40000           #ADC sampling rate, must be calibrated as it is dependent on the speed of the
